...
Функция ПолучитьДоступныйИнтерфейсПлагинов()
	...
	ДоступныйИнтерфейсПлагинов.ИзОбъектаИсключая(МенеджерПодписок, "УстановитьПодписчиков ВыполнитьПодпискуНаСобытие ПрисвоитьЗначенияПараметраПроцедуры ЗаполнитьПодписчиковПоИндексу ПриСозданииОбъекта");
