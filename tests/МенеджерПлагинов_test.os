...
Функция ПолучитьСписокТестов(Знач Тестирование) Экспорт
	...
	ИменаТестов.Добавить("ТестДолжен_ПроверитьПлагины");
...
Процедура ТестДолжен_ПроверитьПлагины() Экспорт
	...
	Ожидаем.Что(ВсеПлагины.Количество(), "Количество плагинов должно быть равны").Равно(1);
...
Процедура ТестДолжен_ПроверитьВключениеПлагинов() Экспорт
	...
	Ожидаем.Что(МенеджерПлагинов.ПолучитьПлагинПоИмени("test_plugin").Включен(), "Плагин должен быть включен").ЭтоИстина();
...
Процедура ТестДолжен_ПроверитьВыключениеПлагинов() Экспорт
	...
	Ожидаем.Что(МенеджерПлагинов.ПолучитьПлагинПоИмени("test_plugin").Включен(), "Плагин должен быть выключен").ЭтоЛожь();
